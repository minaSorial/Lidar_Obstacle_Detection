...
typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
{
    ...
    typename pcl::PointCloud<pcl::PointXYZI>::Ptr CloudFiltered (new pcl::PointCloud<pcl::PointXYZI> ());
...
std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::SeparateClouds(pcl::PointIndices::Ptr inliers, typename pcl::PointCloud<PointT>::Ptr cloud) 
{
  //  Create two new point clouds, one cloud with obstacles and other with segmented plane
    ...
    extract.setNegative (true);
    // The resulting cloud_out is identical to cloud, but all points referenced by inliers are made NaN:
...
)
{
    ...
    {
        std::cout <<"Could not estimate a planer moder for the given dataset"<<std::endl;
    }
    ...
    //seperate planes from obstacles
